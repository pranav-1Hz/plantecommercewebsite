...
const AddPlant = () => {
  ...
  const handleSubmit = e => {
    ...
    const newPlant = {
      ...
      plantImage:
        formData.plantImage ||
        'https://images.unsplash.com/photo-1463320898484-cdee8141c787?ixid=MXwxMjA3fDB8MHxzZWFyY2h8M3x8cGxhbnRzfGVufDB8fDB8&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60',
    };
        ...
        <StyledForm onSubmit={handleSubmit}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
            ...
            <StyledFormGroup>
              ...
              <StyledSelect name="plantType" value={formData.plantType} onChange={handleChange}>
